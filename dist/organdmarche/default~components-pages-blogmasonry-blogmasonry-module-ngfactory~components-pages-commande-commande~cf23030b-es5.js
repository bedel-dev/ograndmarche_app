(function () {
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~components-pages-blogmasonry-blogmasonry-module-ngfactory~components-pages-commande-commande~cf23030b"], {
    ...
    /***/
    function GytN(module, exports, __webpack_require__) {
      (function (global, factory) {
        true ? factory(__webpack_require__(
        /*! @angular/core */
        "8Y7J"), __webpack_require__(
        /*! @angular/common */
        "SVse"), exports, __webpack_require__(
        /*! @angular/core */
        "8Y7J"), __webpack_require__(
        /*! @angular/common */
        "SVse"), __webpack_require__(
        /*! rxjs */
        "qCKp")) : undefined;
        ...
        function () {
          ...
          */
          function (el, h) {
            ...
            var elBottom = elTop + elH; // if 0, the element is considered in the viewport as soon as it enters.
          ...
          */
          function (_element, options) {
            /** @type {?} */
            var Masonry = __webpack_require__(
            /*! masonry-layout */
            "hNNL");
          ...
          */
          function () {
            ...
            if (this.useImagesLoaded) {
              this.imagesLoaded = __webpack_require__(
              /*! imagesloaded */
              "vX6Q");
          ...
          */
          function () {
            var _this = this; // initialize masonry


            this._msnry = this.initializeMasonry(this.el, this.masonryOptions); // use animation options if useAnimation is true
          ...
          */
          function () {
            ...
            var items = this._msnry.items.map(function (item) {
              return item.element;
            });
          ...
          */
          function (element) {
            ...
            var addStatus = this.masonryOptions.addStatus.toLowerCase(); // set margin bottom of gutter value.
            ...
            if (this.useImagesLoaded) {
              setTimeout(function () {
                _this.imagesLoaded(element, function (instance) {
                  ...
                  _this.items.push(element); // append or prepend based on masonry option
              ...
              setTimeout(function () {
                ...
                if (addStatus === 'prepend') {
                  if (_this._msnry.items.length !== 0) {
                    _this.el.insertBefore(element, _this._msnry.items[0].element); // this._msnry.prepended(itemElem);

                  } else {
                    _this.el.appendChild(element); // this._msnry.appended(itemElem);
                  ...
                  _this.el.appendChild(element); // this._msnry.addItems(itemElem);
          ...
          function (element) {
            ...
            if (this.useImagesLoaded) {
              ...
              setTimeout(function () {
                if (addStatus === 'prepend') {
                  if (_this._msnry.items.length !== 0) {
                    _this.el.insertBefore(element, _this._msnry.items[0].element); // this._msnry.prepended(element);

                  } else {
                    _this.el.appendChild(element); // this._msnry.appended(element);
                  ...
                  _this.el.appendChild(element); // this._msnry.addItems(element);
          ...
          */
          function (observer, elem) {
            ...
            if (elem) {
              ...
              var transitionEnd_1 = function transitionEnd_1() {
                /** @type {?} */
          ...
          NgMasonryGridService.ɵfac = function NgMasonryGridService_Factory(t) {
            return new (t || NgMasonryGridService)(ɵngcc0.ɵɵinject(core.PLATFORM_ID));
          };

          NgMasonryGridService.ɵprov = ɵngcc0.ɵɵdefineInjectable({
            token: NgMasonryGridService,
            factory: function factory(t) {
              return NgMasonryGridService.ɵfac(t);
            }
          });
          /*@__PURE__*/

          (function () {
            ɵngcc0.ɵsetClassMetadata(NgMasonryGridService, [{
        ...
        var NgMasonryGridComponent =
        /** @class */
        function () {
          function NgMasonryGridComponent(_platformId, _element, masonryGridService) {
            this._platformId = _platformId;
            this._element = _element;
            this.masonryGridService = masonryGridService; // Inputs

            this.masonryOptions = {};
            this.useAnimation = false;
            this.useImagesLoaded = false; // Outputs
          ...
          * @return {?}
          */
          function () {// initialize masonry after View Initialization
            // this.initializeMasonry();
          };
          /**
           * @return {?}
          ...
          */
          function () {
            var _this = this; // initialize Masonry with Animation effects


            this._msnry = this.masonryGridService.init(this._element.nativeElement, this.masonryOptions, this.useAnimation, this.scrollAnimationOptions, this.useImagesLoaded); // Bind to Masonry events
          ...
          NgMasonryGridComponent.ɵfac = function NgMasonryGridComponent_Factory(t) {
            return new (t || NgMasonryGridComponent)(ɵngcc0.ɵɵdirectiveInject(core.PLATFORM_ID), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(NgMasonryGridService));
          };

          NgMasonryGridComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({
            type: NgMasonryGridComponent,
            selectors: [["", "ng-masonry-grid", ""], ["ng-masonry-grid"]],
            inputs: {
            ...
            decls: 1,
            vars: 0,
            template: function NgMasonryGridComponent_Template(rf, ctx) {
              if (rf & 1) {
          ...
          (function () {
            ɵngcc0.ɵsetClassMetadata(NgMasonryGridComponent, [{
              type: core.Component,
              args: [{
        ...
        function () {
          ...
          * @return {?}
          */
          function () {// this._parent.add(this._element.nativeElement);
          };
          /**
          ...
          */
          function () {
            if (common.isPlatformBrowser(this.platformId)) {
              this.masonryGridService.itemsCount++; // set count attribute for every grid item

              this._element.nativeElement.setAttribute('data-count', this.masonryGridService.itemsCount); // if (this.masonryGridService.masonryOptions.horizontalOrder) {
          ...
          */
          ...
          NgMasonryGridDirective.ɵfac = function NgMasonryGridDirective_Factory(t) {
            return new (t || NgMasonryGridDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(core.forwardRef(function () {
              return NgMasonryGridComponent;
            })), ɵngcc0.ɵɵdirectiveInject(core.PLATFORM_ID), ɵngcc0.ɵɵdirectiveInject(NgMasonryGridService));
          };

          NgMasonryGridDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({
            type: NgMasonryGridDirective,
            selectors: [["", "ng-masonry-grid-item", ""], ["ng-masonry-grid-item"]]
          });
          /*@__PURE__*/

          (function () {
            ɵngcc0.ɵsetClassMetadata(NgMasonryGridDirective, [{
              type: core.Directive,
              args: [{
        ...
        var NgMasonryGridModule =
        /** @class */
        function () {
          function NgMasonryGridModule() {}

          NgMasonryGridModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({
            type: NgMasonryGridModule
          });
          NgMasonryGridModule.ɵinj = ɵngcc0.ɵɵdefineInjector({
            factory: function NgMasonryGridModule_Factory(t) {
              return new (t || NgMasonryGridModule)();
            },
          ...
          (function () {
            (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgMasonryGridModule, {
          ...
          (function () {
            ɵngcc0.ɵsetClassMetadata(NgMasonryGridModule, [{
              type: core.NgModule,
              args: [{
                imports: [common.CommonModule],
                exports: [NgMasonryGridComponent, NgMasonryGridDirective],
    ...
    /***/
    function vX6Q(module, exports, __webpack_require__) {
      var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;
      /*!
      * imagesLoaded v4.1.4
      ...
      */
      ...
      (function (window, factory) {
        ...
        if (true) {
          ...
          !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(
          /*! ev-emitter/ev-emitter */
          "CUlp")], __WEBPACK_AMD_DEFINE_RESULT__ = function (EvEmitter) {
...
//# sourceMappingURL=default~components-pages-blogmasonry-blogmasonry-module-ngfactory~components-pages-commande-commande~cf23030b-es5.js.map