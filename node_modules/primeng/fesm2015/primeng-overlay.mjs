...
class Overlay {
    ...
    get modal() {
        var _a;
        return this.mode === 'modal' || (this.overlayResponsiveOptions && this.window.matchMedia(((_a = this.overlayResponsiveOptions.media) === null || _a === void 0 ? void 0 : _a.replace('@media', '')) || `(max-width: ${this.overlayResponsiveOptions.breakpoint})`).matches);
    }
    get overlayMode() {
