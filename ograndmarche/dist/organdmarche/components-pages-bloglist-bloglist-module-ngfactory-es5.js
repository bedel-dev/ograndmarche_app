    ...
    function WZ(module, __webpack_exports__, __webpack_require__) {
      ...
      function View_ContentComponent_0(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵqud"](671088640, 1, {
          ...
          var currVal_5 = !_co.display && !_co.forgotpass && !_co.changePass;
          ...
          var currVal_7 = _co.forgotpass && _co.verificateCompte;

          _ck(_v, 24, 0, currVal_7);

          var currVal_8 = _co.changePass;

          _ck(_v, 26, 0, currVal_8);

          var currVal_9 = _co.forgotpass && !_co.verificateCompte && !_co.display;

          _ck(_v, 28, 0, currVal_9);
        }, function (_ck, _v) {
          var _co = _v.component;

          var currVal_1 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵinlineInterpolate"](1, "", _co.imagurl, "avatar.png");

          _ck(_v, 9, 0, currVal_1);

          var currVal_2 = _co.User.name;

          _ck(_v, 11, 0, currVal_2);

          var currVal_3 = _co.User.role;

          _ck(_v, 13, 0, currVal_3);

          var currVal_4 = _co.User.created_at;
            ...
            try {
              this.commandeService.GetUser().subscribe(function (res) {
                ...
                if (res['message'] == "authentication failed Token not valide") {
                  ...
                  res['response']['data'].created_at = _this2.date;
                  _this2.User = res['response']['data'];
                  localStorage.setItem('userdata', JSON.stringify(_this2.User));
                  console.log("user : ", JSON.parse(localStorage.getItem('userdata')));
                  _this2.name = _this2.User.name;

                  if (_this2.User.name == "lidardefaultmail@lidar.ci") {
                    _this2.email == "";
                  } else {
                    _this2.email = _this2.User.email;
                  }

                  _this2.localite = _this2.User.locality;

                  var newnember = _this2.User.contact.split(" ");

                  _this2.phoneNumber = newnember[1];
                  console.log(_this2.phoneNumber);
                }
              }, function (error) {
          ...
          value: function onClickValidateCompte(data) {
            ...
            this.http.post(_common_global_constants__WEBPACK_IMPORTED_MODULE_5__["GlobalConstants"].api_auth + '/forgetPass.json', body, {
              ...
              if (res['response']['code'] === '200') {
                ...
                _this4.verificateCompte = true;
                _this4.forgotpass = true;
                _this4.User = res['response']['user'];
                console.log(res['response']['user']);
              } else {
                _this4.validationcode = "";
                _this4.verificateCompte = false; //  this.forgotpass = false
                //this.alertConfirmation()
          ...
          value: function onClickSaveUpdateUser(data) {
            ...
            this.http.post(_common_global_constants__WEBPACK_IMPORTED_MODULE_5__["GlobalConstants"].api_auth + '/edituser/' + this.User.id + '.json', body, {
              ...
              if (res['response']['code'] === 200) {
                ...
                _this5.forgotpass = false;
                _this5.verificateCompte = false;
                _this5.changePass = false;
